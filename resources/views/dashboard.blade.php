        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="action-list flex flex-row justify-between space-x-2">
                        <div class="w-1/3 py-2 px-5 border-green-800 bg-green-200">
                        ...
                        <div class="w-1/3 py-2 px-5 border-blue-800 bg-blue-200">
                        ...
                        <div class="w-1/3 py-2 px-5 border-yellow-800 bg-yellow-200">
                            <p class="text-2xl font-bold pb-5">Wallet Statements</p>
                            <ul class="actions list-disc px-5">
                                @forelse($wallets as $wallet)
                                    <li>
                                ...
                                @empty
                                    No wallets created to have any transaction statements. Create one wallet first and make some transactions.
                                @endforelse
                            </ul>
                        </div>
                    </div>
